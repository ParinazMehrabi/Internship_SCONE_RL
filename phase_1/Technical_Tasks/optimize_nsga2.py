...
def main():
    ...
    plt.ylabel("Effort (mean muscle activation^2)")
    ...
    best_effort_idx = np.argmin(res.F[:, 1])

    for label, idx in [("best_knee_match", best_knee_idx), ("most_efficient", best_effort_idx)]:
        ...
        print(f"Label: {label}, Result: {knee_result}, Effort: {effort}")
